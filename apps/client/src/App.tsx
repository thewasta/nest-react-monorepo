    ...
    return (
        <div className="flex flex-col min-h-screen items-center justify-center bg-gray-100 p-4">
            <header className="flex flex-col items-center w-full md:w-1/2 lg:w-1/3">
                ...
                <h2 className="text-lg font-medium text-gray-600">Score Tracker</h2>
            </header>
            <main className="flex flex-col items-center w-full md:w-1/2 lg:w-1/3 mt-10">
                ...
                <div className="mb-5">
                    <a className="text-white bg-gray-700 hover:bg-gray-800 rounded-lg px-5 py-2.5 cursor-pointer"
                       onClick={() => {
                           if (findingGame) {
                               return false;
                           }
